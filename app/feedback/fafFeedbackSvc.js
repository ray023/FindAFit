    ...
    .factory('Feedback', function($http, $q, $ionicLoading, Settings) {
        return {
            send: function(message, contact) {
                ...
                var encodedCordova = encodeValue(device.cordova);
                var encodedDeviceModel = encodeValue(device.model);
                var encodedDevicePlatform = encodeValue(device.platform);
                var encodedDeviceUuid = encodeValue(device.uuid);
                var encodedDeviceVersion = encodeValue(device.version);

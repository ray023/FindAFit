...
fafApp.directive('fafGoogleMap', function() {
    return {
        templateUrl: "app/shared/partials/fafGoogleMap.html",
        restrict: "E"
    }
});
...
fafApp.directive('fafUpgradeListing', function() {
    return {
        templateUrl: "app/shared/partials/fafUpgradeListing.html",
        restrict: "E"
    }
});

fafApp.directive('fafBoxFlair', function() {
    return {
        templateUrl: "app/shared/partials/fafBoxFlair.html",
        restrict: "E"
    }
});